...
router.post("/create-checkout-session", async (req, res) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: "https://payment-server-production-0699.up.railway.app/stripe/checkout-success",
    cancel_url:  "https://payment-server-production-0699.up.railway.app/stripe/cancel",
  });
